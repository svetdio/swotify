...
async def predict(ratings: PredictionInput, model: Union[str, None] = None ):
    ...
    if model is not None:
        ...
        self_train_desc = {
            "desc": model_desc[selected_model['model']],
            "f1score": selected_model['test_f1'],
            "accuracy": selected_model['acc'],
        }
    ...
    return {
        ...
        "self_train_desc": self_train_desc
    }
